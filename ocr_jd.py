...
def show_jd_interview():
    ...
    def extract_text_from_image(image):
        ...
        try:
            ...
            raise Exception("OCR Failed: Groq Vision Model unavailable AND Tesseract not installed. Please use 'Paste Text' mode.")
    ...
    if input_mode == "Upload Image":
        uploaded_file = st.file_uploader(
            "📎 Upload JD (Image or Document)",
            type=["png", "jpg", "jpeg", "pdf", "docx", "doc", "txt"],
            help="Supported: Images (PNG, JPG) or Documents (PDF, DOCX, TXT)"
        )
        if uploaded_file:
            ...
            if file_type in ["png", "jpg", "jpeg"]:
                ...
                # Document processing (direct text extraction)
    ...
    if st.session_state.jd_text and not st.session_state.interview_active:
        ...
        st.info("👇 Please check the extracted text below. content can be edited if needed.")
